														...
														render={({ field }) => (
															<FormItem>
																...
																<div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-1 text-sm">
																	<div
																		className={`flex items-center space-x-2 ${/[A-Z]/.test(field.value) ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}
																	>
																	...
																	<div
																		className={`flex items-center space-x-2 ${/[0-9]/.test(field.value) ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}
																	>
																	...
																	<div
																		className={`flex items-center space-x-2 ${/[^A-Za-z0-9]/.test(field.value) ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}
																	>
																	...
																	<div
																		className={`flex items-center space-x-2 ${field.value.length >= 8 ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}
																	>
													...
													<FormField
														...
														render={({ field }) => (
															<FormItem>
																...
																<FormDescription>
																	This could be a project, research area, or
																	professional role
																</FormDescription>
																<FormMessage />
															</FormItem>
