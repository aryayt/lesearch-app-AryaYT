...
export const metadata: Metadata = {
	...
	description:
		"LeSearch is an AI-powered research assistant that helps users summarize, analyze, and interact with documents efficiently.",
	keywords: [
		"LeSearch",
	...
	openGraph: {
		...
		description:
			"LeSearch simplifies document understanding with AI-driven insights, summaries, and interactive Q&A.",
	...
	twitter: {
		...
		title: "LeSearch - AI Research Assistant",
		description:
			"Save time and enhance research efficiency with AI-driven document analysis and summarization.",
