...
const features = [
	...
	},
	{
		...
		description:
			"Discover connections between papers and identify key influencers in your field.",
		icon: Network,
		color: "cyan",
	},
	{
		...
		<section id="features" className="py-20 sm:py-28 relative">
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
				<div className="text-center mb-16">
					...
					>
						LeSearch helps you find, understand, and organize information faster
						than ever before.
					</TextEffect>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{features.map((feature, index) => (
						...
						>
							...
							>
								<feature.icon
									className={`w-6 h-6 ${colorTokenMap[feature.color as keyof typeof colorTokenMap].text}`}
								/>
							</div>
