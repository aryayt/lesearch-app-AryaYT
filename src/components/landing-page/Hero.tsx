				...
				<div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
					...
					>
						...
						<p className="text-lg text-muted-foreground/80 mb-8">
							Find references instantly. LeSearch helps you access cited papers
							with a single click and get answers to your questions directly
										...
										<div className="flex space-x-3">
											...
											<div className="flex-1">
												<p className="text-sm text-card-foreground bg-muted p-3 rounded-lg rounded-tl-none">
													What are the key differences between quantum and
													classical computing?
												</p>
											</div>
										</div>
										<div className="flex space-x-3">
											...
											<div className="flex-1">
												<p className="text-sm text-card-foreground bg-secondary p-3 rounded-lg rounded-tl-none">
													...
													can exist in multiple states simultaneously due to
													superposition, while classical bits are binary (0 or
													1).
													<br />
													2.{" "}
													<span className="text-primary">
													...
													allows qubits to be correlated in ways impossible for
													classical bits.
													<br />
													3.{" "}
													<span className="text-primary">
													...
													enables certain calculations to be performed
