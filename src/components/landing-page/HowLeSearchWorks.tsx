...
const features = [
	...
	},
	{
		...
		description:
			"Extract key insights, summaries, and answers within seconds from any referenced document.",
	},
	{
		icon: FolderOpen,
		title: "Smart Organization",
		description:
			"Automatically organize your references by themes, concepts, and relationships for easy access.",
	},
];
		...
		<section id="how-it-works" className="py-20 sm:py-28 relative">
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
				<div className="text-center mb-16 animate-hidden">
					...
					>
						LeSearch uses advanced AI to transform how you handle research
						references, letting you focus on insights rather than chasing
						citations.
					</TextEffect>
				</div>
