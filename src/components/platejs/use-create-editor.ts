...
import { copilotPlugins } from "@/components/platejs/copilot-plugins";
import { editorPlugins } from "@/components/platejs/editor-plugins";
import { FixedToolbarPlugin } from "@/components/platejs/fixed-toolbar-plugin";
import { FloatingToolbarPlugin } from "@/components/platejs/floating-toolbar-plugin";
			...
			override: {
				components: {
					...(readOnly
						...
						: placeholders
							? withPlaceholders(
									editorComponents as Record<string, ComponentType<object>>,
								)
							: editorComponents),
					...components,
				},
