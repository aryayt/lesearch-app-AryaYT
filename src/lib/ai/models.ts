...
export const googleModels: Array<GoogleModel> = [
	...
	},
	{
		...
		description:
			"Optimized for high quality, natural conversational audio outputs with thinking.",
		inputFormats: ["audio", "videos", "text"],
		outputFormats: ["text", "audio"],
	},
	{
		...
		description:
			"Optimized for low latency, controllable text-to-speech audio generation.",
		inputFormats: ["text"],
		outputFormats: ["audio"],
	},
	{
		...
		description:
			"Optimized for enhanced thinking and reasoning, multimodal understanding, and advanced coding.",
		inputFormats: ["audio", "images", "videos", "text"],
		outputFormats: ["text"],
	},
	{
	...
	},
	{
		...
		description:
			"Optimized for fast and versatile performance across diverse tasks.",
		inputFormats: ["audio", "images", "videos", "text"],
		outputFormats: ["text"],
	},
	{
...
export const openaiModels: Array<OpenAIModel> = [
	{
		...
		name: "GPT-4o Mini",
		description:
			"GPT-4o Mini is a general-purpose model that can be used for a variety of tasks.",
		inputFormats: ["text"],
		outputFormats: ["text"],
	},
	{
		...
		name: "GPT-4o",
		description:
			"GPT-4o is a general-purpose model that can be used for a variety of tasks.",
		inputFormats: ["text"],
		outputFormats: ["text"],
	},
	{
		...
		name: "GPT-4",
		description:
			"GPT-4 is a general-purpose model that can be used for a variety of tasks.",
		inputFormats: ["text"],
		outputFormats: ["text"],
	},
	{
		...
		name: "GPT-3.5 Turbo",
		description:
			"GPT-3.5 Turbo is a general-purpose model that can be used for a variety of tasks.",
		inputFormats: ["text"],
		outputFormats: ["text"],
	},
];
